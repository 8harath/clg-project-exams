export const subjectData = [
  ...
  },
  {
    ...
    modules: 5,
    description:
      "This open elective course allows students to explore topics outside their core discipline, broadening their knowledge and skills in diverse areas.",
    moduleList: [
      {
        title: "Introduction to the Elective",
        description: "Overview and importance of the elective subject.",
        presentation: true,
      },
      {
        title: "Core Concepts",
        description: "Fundamental principles and theories of the subject.",
        presentation: true,
      },
      {
        title: "Applications",
      ...
      {
        title: "Future Trends",
        description: "Emerging developments and future directions in the field.",
        presentation: true,
      },
    ],
    facultyQuestions: "Faculty-provided questions covering key concepts and applications.",
    avalonPredictions: "AI-predicted questions focusing on practical applications and theoretical understanding.",
  },
  {
